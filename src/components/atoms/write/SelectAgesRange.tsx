        ...
        <div className="flex flex-col justify-center mt-4 w-full">
            ...
            <div className="relative flex justify-between w-full px-4 mt-2"> */}
                ...
                <input
                    ...
                    className="bg-grayscale-color-85 w-full px-4 py-1 xl:py-2 rounded-full text-right pr-5 items-center"
                />
                ...
                <input
                    ...
                    className="items-center bg-grayscale-color-85 w-full px-4 py-1 xl:py-2 rounded-full text-right pr-5"
                />
            </div>
