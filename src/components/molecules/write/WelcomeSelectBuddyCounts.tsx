...
export default function WelcomeSelectBuddyCounts() {
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="flex mt-10 mb-5 text-2xl xl:text-4xl xl:mt-20 xl:mb-20">
                여정 인원을 선택해주세요
            </div>
            ...
            <div className="flex flex-row gap-[2px]">
                <button
                    className="text-[#647484] w-[50px] h-[50px] bg-[#edeff1] hover:bg-gray-400 flex items-center justify-center"
                    onClick={() => {
                        if (count > 1) {
                            setCount(count - 1);
                        }
                ...
                />
                <div className="bg-[#edeff1] w-[50px] h-[50px] text-[#647484] md:text-base flex items-center justify-center cursor-default">
                    <span>{count}</span>
                </div>
